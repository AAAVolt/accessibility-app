...
def save_results(results_df, output_file='accessibility_with_times_urgencias_leves.csv'):
...
if __name__ == "__main__":
    ...
    accessibility_file = r"C:\Users\avoltan\Desktop\OD_walk_data\urgencias_lleves_accessibility.csv"
    ...
    if not results.empty:
        ...
        # Save results
        save_results(results, 'results/accessibility_with_times_hospital.csv')
