...
if __name__ == "__main__":
    ...
    input_file = r"C:\Users\avoltan\PyCharmMiscProject\accessibility\results\accessibility_with_times_urgencias_leves.csv"
    output_file = "results/datos_accesibilidad_urgencias_leves.csv"
