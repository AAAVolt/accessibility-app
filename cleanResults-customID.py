...
if __name__ == "__main__":
    ...
    input_file = r"C:\Users\avoltan\PyCharmMiscProject\accessibility\results\accessibility_with_times_especialistas.csv"
    output_file = "results/datos_accesibilidad_especialistas.csv"
